...
public class RayCaster extends GSetup {
    ...
    public void initialize() {
        ...
        fs = SetupManager.Debug.runFullScreen();
        if(fs) {
            exit = new GFrameButton(0,300,70,70);
            exit.setText("Exit");
            addFrameButton(exit);
        }
...
//                imageToScale.fillRectangle((int) (((double) i / depth.size()) * screenWidth), screenHeight / 2 - (int) (height / 2), screenHeight / depth.size() + 1, (int) height,Color.BLACK);
